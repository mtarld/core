...
final class DoctrineExtractor implements PropertyListExtractorInterface, PropertyTypeExtractorInterface, PropertyAccessExtractorInterface
{
     ...
     * {@inheritdoc}
     *
     * @deprecated since 3.3, use "getType" instead
     *
     * @return LegacyType[]|null
     */
    public function getTypes($class, $property, array $context = []): ?array
    {
        trigger_deprecation('api-platform/core', '3.3', 'The "%s()" method is deprecated, use "%s::getType()" instead.', __METHOD__, self::class);
