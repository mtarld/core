...
class TypeBuilderTest extends TestCase
{
    ...
    public function testIsObjectCollection(Type $type, bool $expectedIsObjectCollection): void
    {
        $this->assertSame($expectedIsObjectCollection, $this->typeBuilder->isObjectCollection($type));
    }
    ...
    public static function typesProvider(): array
    {
        return [
            ...
            [Type::object(), false],
            [Type::resource(), false],
            [Type::collection(Type::object('foo')), false],
            [Type::array(), false],
            [Type::array(Type::object()), false],
            [Type::collection(Type::object('foo'), Type::object('className')), true],
            [Type::array(Type::object('className')), true],
        ];
    }
}
