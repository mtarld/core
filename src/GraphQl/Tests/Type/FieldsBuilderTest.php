...
class FieldsBuilderTest extends TestCase
{
        ...
        foreach ($properties as $propertyName => $propertyMetadata) {
            ...
            if ('propertyNestedResource' === $propertyName) {
                ...
                if (method_exists(ApiProperty::class, 'getPhpType')) {
                    ...
                    $this->typeConverterProphecy->convertType(Argument::type(LegacyType::class), Argument::type('bool'), Argument::that(static fn (Operation $arg): bool => $arg->getName() === $operation->getName()), 'nestedResourceClass', $resourceClass, $propertyName, $depth + 1)->willReturn(new ObjectType(['name' => 'objectType', 'fields' => []]));
                }
    ...
    public static function resourceObjectTypeFieldsProvider(): iterable
    {
        ...
        yield 'query' => ['resourceClass', (new Query())->withClass('resourceClass'),
            [
                'property' => new ApiProperty(),
                'propertyBool' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withReadable(true)->withWritable(false),
                'propertyNotReadable' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withReadable(false)->withWritable(false),
                'nameConverted' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_STRING)])->withReadable(true)->withWritable(false),
            ],
            false, 0, null,
            [
                'id' => [
        ...
        yield 'query with advanced name converter' => ['resourceClass', (new Query())->withClass('resourceClass'),
            [
                'field' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_STRING)])->withReadable(true)->withWritable(false),
            ],
            false, 0, null,
            [
                'id' => [
        ...
        yield 'query input' => ['resourceClass', (new Query())->withClass('resourceClass'),
            [
                'property' => new ApiProperty(),
                'propertyBool' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withReadable(false)->withWritable(true),
                'nonWritableProperty' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_STRING)])->withReadable(false)->withWritable(false),
            ],
            true, 0, null,
            [
                'id' => [
        ...
        yield 'query with nested resources' => ['resourceClass', (new Query())->withClass('resourceClass'),
            [
                'propertyNestedResource' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, 'nestedResourceClass')])->withReadable(true)->withWritable(true),
            ],
            false, 0, null,
            [
                'id' => [
        ...
        yield 'mutation non input' => ['resourceClass', (new Mutation())->withClass('resourceClass')->withName('mutation'),
            [
                'property' => new ApiProperty(),
                'propertyBool' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withReadable(false)->withWritable(true),
                'propertyReadable' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withReadable(true)->withWritable(true),
                'propertyObject' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, 'objectClass')])->withReadable(true)->withWritable(true),
            ],
            false, 0, null,
            [
                'id' => [
        ...
        yield 'mutation input' => ['resourceClass', (new Mutation())->withClass('resourceClass')->withName('mutation'),
            [
                'property' => new ApiProperty(),
                'propertyBool' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withDescription('propertyBool description')->withReadable(false)->withWritable(true)->withDeprecationReason('not useful'),
                'propertySubresource' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withReadable(false)->withWritable(true),
                'nonWritableProperty' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_STRING)])->withReadable(false)->withWritable(false),
                'id' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_INT)])->withReadable(false)->withWritable(true),
            ],
            true, 0, null,
            [
                'id' => [
        ...
        yield 'custom mutation' => ['resourceClass', (new Mutation())->withResolver('resolver')->withName('mutation'),
            [
                'propertyBool' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_BOOL)])->withDescription('propertyBool description')->withReadable(false)->withWritable(true),
            ],
            true, 0, null,
            [
                'propertyBool' => [
        ...
        yield 'invalid types' => ['resourceClass', (new Query())->withClass('resourceClass'),
            [
                'propertyInvalidType' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_NULL)])->withReadable(true)->withWritable(false),
                'propertyNotRegisteredType' => (new ApiProperty())->withBuiltinTypes([new LegacyType(LegacyType::BUILTIN_TYPE_CALLABLE)])->withReadable(true)->withWritable(false),
            ],
            false, 0, null,
            [
                'id' => [
