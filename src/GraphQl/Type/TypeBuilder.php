...
final class TypeBuilder implements TypeBuilderInterface, TypeBuilderEnumInterface
{
    ...
    /**
     * @deprecated since 3.3, use isObjectCollection instead
     *
     * {@inheritdoc}
     */
    public function isCollection(LegacyType $type): bool
    {
        trigger_deprecation('api-platform/graphql', '3.3', 'The "%s()" method is deprecated, use "isObjectCollection()" instead.', __METHOD__);
    ...
    public function isObjectCollection(Type $type): bool
    {
        ...
        try {
            return $type->asNonNullable()->getCollectionValueType()->getBaseType() instanceof ObjectType;
