...
trait FieldDatatypeTrait
{
    ...
    private function getNestedFieldPath(string $resourceClass, string $property): ?string
    {
        ...
        $collectionValueTypeIsResourceClass = static function (Type $type) use (&$className, $typeIsResourceClass): bool {
            return $type instanceof CollectionType && $type->getCollectionValueType()->isSatisfiedBy($typeIsResourceClass);
        };
