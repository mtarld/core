...
class ItemNormalizerTest extends TestCase
{
    ...
    public function testDenormalize(): void
    {
        ...
        $relatedDummyType = class_exists(Type::class) ? Type::object(RelatedDummy::class) : [new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, RelatedDummy::class)];
        $relatedDummiesType = class_exists(Type::class) ? Type::collection(Type::object(ArrayCollection::class), $relatedDummyType, Type::int(), asList: true) : [new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, ArrayCollection::class, true, new LegacyType(LegacyType::BUILTIN_TYPE_INT), $relatedDummyType)];

        $propertyMetadataFactoryProphecy = $this->prophesize(PropertyMetadataFactoryInterface::class);
        $propertyMetadataFactoryProphecy->create(Dummy::class, 'name', Argument::any())->willReturn((new ApiProperty())->withBuiltinTypes(class_exists(Type::class) ? Type::string() : [new LegacyType(LegacyType::BUILTIN_TYPE_STRING)])->withDescription('')->withReadable(false)->withWritable(true));
        $propertyMetadataFactoryProphecy->create(Dummy::class, 'ghost', Argument::any())->willReturn((new ApiProperty())->withBuiltinTypes(class_exists(Type::class) ? Type::string() : [new LegacyType(LegacyType::BUILTIN_TYPE_STRING)])->withDescription('')->withReadable(false)->withWritable(true));
    ...
    public function testDenormalizeCollectionIsNotArray(): void
    {
        ...
        $type = class_exists(Type::class)
            ? Type::collection(Type::object(ArrayCollection::class), Type::object(RelatedDummy::class), Type::int(), asList: true)
            : [new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, ArrayCollection::class, true, new LegacyType(LegacyType::BUILTIN_TYPE_INT), new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, RelatedDummy::class))];
    ...
    public function testDenormalizeCollectionWithInvalidKey(): void
    {
        ...
        $propertyMetadataFactoryProphecy = $this->prophesize(PropertyMetadataFactoryInterface::class);
        $type = class_exists(Type::class)
            ? Type::collection(Type::object(ArrayCollection::class), Type::object(RelatedDummy::class), Type::string())
            : [new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, ArrayCollection::class, true, new LegacyType(LegacyType::BUILTIN_TYPE_STRING), new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, RelatedDummy::class))];
    ...
    public function testDenormalizeRelationIsNotResourceLinkage(): void
    {
        ...
        $propertyMetadataFactoryProphecy->create(Dummy::class, 'relatedDummy', [])->willReturn(
            (new ApiProperty())->withBuiltinTypes(class_exists(Type::class) ? Type::object(RelatedDummy::class) : [new LegacyType(LegacyType::BUILTIN_TYPE_OBJECT, false, RelatedDummy::class)])->withReadable(false)->withWritable(true)->withReadableLink(false)->withWritableLink(false)
        );
